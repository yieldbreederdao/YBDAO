...
// ----------------------------------------------------------------------------
// 'YBREE' token contract

// Symbol      : YBREE 
// Name        : YBDAO 
// Total supply: 10 million (token mintable by owner removed)
// Decimals    : 18
// ----------------------------------------------------------------------------
...
contract Token is ERC20Interface, Owned {
    ...
    string public symbol = "YBREE";
    string public  name = "YBDAO";
    uint256 public decimals = 18;
    uint256 public currentSupply = 2e6 * 10**(decimals); // 2 million
    uint256 _totalSupply = 1e7 * 10 ** (decimals); // 10 million
